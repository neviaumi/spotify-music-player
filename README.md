...
To make PollyJS record all network call
You sign token from [here](https://developer.spotify.com/console/get-current-user/)

Required scope can check [./src/config/openidConfiguration.ts](./src/config/openidConfiguration.ts)

```bash
REACT_APP_SPOTIFY_ACCESS_TOKEN=ACCESS_TOKEN yarn test:reset
```
